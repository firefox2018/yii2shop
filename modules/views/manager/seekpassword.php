...
<div class="row-fluid login-wrapper">
    ...
    <div class="span4 box">
        <div class="content-wrap">
            ...
            <?= $form->field($model,'repeatpass')->passwordInput(['class'=>'span12','placeholder'=>'重复密码'])?>
            <?php
                if(Yii::$app->session->hasFlash('info')){
                    echo Html::encode(Yii::$app->session->getFlash('info'));
                }
            ?>
            <a href="<?php echo yii\helpers\Url::to(['public/login']); ?>" class="forgot">返回登录</a>
            <div class="form-group">
                <div class="col-lg-offset-1 col-lg-11">
                    <?= Html::submitButton('修改密码', ['class' => 'btn btn-glow login']) ?>
                </div>
            </div>
        </div>
    </div>
