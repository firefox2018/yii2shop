                ...
                <?php foreach($managers as $manager): ?>
                    ...
                    <tr>
                        ...
                        <td class="align-right">
                            <a href="<?php echo yii\helpers\Url::to(['manager/assign', 'adminid' => $manager->adminid]) ?>">授权</a>
                            <a href="<?php echo yii\helpers\Url::to(['manager/del', 'adminid' => $manager->adminid]) ?>">删除</a>
